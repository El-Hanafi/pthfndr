...
export const metadata: Metadata = {
  title: "PathFinder Marketing & Digital Communication Agency",
  description: "Find your digital way for your business with PathFinder, a design & development studio.",
  openGraph: {
    images: [
      {
